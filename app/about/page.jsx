        ...
        <section className="flex flex-col justify-center items-center w-full p-8">
            ...
            <div className="flex flex-col justify-center items-center text-black p-8 gap-8 w-[90%] bg-purple-300 rounded-xl sm:max-w-2/4 lg:max-w-2/4 ">
                ...
                <div>
                    ...
                    <p className="text-justify font-sans">San Francisco is a city full of culture, diversity, and incredible food. From the iconic waterfront to bustling neighborhoods, food trucks bring the city's vibrant culinary scene to life. We believe street food is an essential part of SF's identity.</p>
                </div>
