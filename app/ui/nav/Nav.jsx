        ...
        <nav className="flex flex-row justify-between items-center w-full bg-purple-950 px-4 relative">
            ...
            <button
                ...
                <ul className={`${ isOpen ? "flex" : "hidden" } flex-col sm:flex sm:flex-row absolute sm:static top-full left-0 w-full sm:w-auto bg-purple-900 sm:bg-transparent shadow-md sm:shadow-none`} >
                    ...
                    <Link href="/" className="p-6 font-medium hover:bg-purple-700 hover:text-white text-center transition duration-200">
                        <li className="font-sans">Home</li>
                    </Link>

                    <Link href="/about" className="p-6 font-medium hover:bg-purple-700 hover:text-white text-center transition duration-200">
                        <li className="font-sans">About</li>
                    </Link>

                    <a href="https://github.com/ValenGu1t0" target="_blank" rel="noopener noreferrer" 
                    className="p-6 font-medium hover:bg-purple-700 hover:text-white text-center transition duration-200">
